...
public interface Message {
    public enum Type {
	AuthenticationRequest, AuthenticationResponse, UserInfoRequest, UserInfoResponse, ContactListRequest, ContactListResponse, PresenceRequest, ChatMessageRequest, ChatMessageResponse
    };
